...
function Home() {
    ...
    useEffect(() => {
        if (sessionStorage.getItem('token')) fetchState();
    }, []);
    useEffect(() => {
            ...
            <WidthBlock>
                ...
                <TopBar>
                    <img
                        ...
                        src={logo}
                    />
                    <img alt="" src={menu} onClick={onClickMenu} />
                </TopBar>
                ...
                <QRBar onClick={onClickLoginCheck}>
                    <h1 onClick={goToLentalStart}>대여하기</h1>
                    <h2 onClick={goToReturnStart}>반납하기</h2>
                </QRBar>

                <GpsBtn onClick={onClickFetchGps}>
                    {gpsLoading ? <GpsLoader /> : <img alt="" src={gps} />}
                </GpsBtn>
                {
                    showPopUp &&
                        (sessionStorage.getItem('token') === null ? (
                            <WarningBar returned={true}>
                                <X src={x} onClick={onClickShowPopUp} />
                                서비스를 이용을 위해&nbsp;
                            ...
                            <WarningBar returned={state !== 'LATE_RETURNED'}>
                                ...
                                {stateTexts[0]}&nbsp;
                                <span
                                    onClick={() => navigate('/my_page/history')}
                                >
                                    {stateTexts[1]}
                                </span>
                                {stateTexts[2]}
