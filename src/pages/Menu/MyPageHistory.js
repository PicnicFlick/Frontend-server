...
function MyPageHistory() {
    ...
    const onChangeSelect = event => {
        ...
        if (value === 'entire') setTmpList([...rentList]);
        else
...
export const TopBarHistory = styled(Flex)`
    position: relative;
